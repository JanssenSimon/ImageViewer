...
public class ImageProcessing {
    ...
    public static BufferedImage applyGammaCorrection(final BufferedImage img, int val) {
        BufferedImage output = new BufferedImage(img.getWidth(), img.getHeight(), img.getType());
        ...
        for (int j = 0; j < img.getHeight(); ++j) {
            for (int i = 0; i < img.getWidth(); ++i) {
                ...
                //gamma correction
                brightness = (float) (Math.pow(brightness, (val / 100.0)));

                //convert to rgb and write the pixel to the output
    ...
    public static BufferedImage applySharpening(BufferedImage img) {
